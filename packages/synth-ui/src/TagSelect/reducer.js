 ...
 * @property {number} activeTag
 * @property {Tag[]} createdTags
 * @property {string} filter
 * @property {Tag[]} filteredTags
 * @property {number} groupAfter
 * @property {Tag[]} groupedSelectedTags
 * @property {boolean} hasTagsSelected
 * @property {Tag[]} originalTags
 * @property {Tag[]} selectedTags
 * @property {boolean} single
 * @property {Tag[]} ungroupedSelectedTags
 * @property {Tag[]}unselectedTags
 */
...
/**
 * @param {State} state
 * @param {{ query?: string, tag?: { value: string, label: string }, type: string, }} action
 */
